    ...
    static const std::string manifest = R"json(
{
    ...
    "engineSettingsModel": {
        "settings": [
            ...
            {
                "name": "enableLLMIntegration",
                "type": "boolean",
                "defaultValue": true,
                "description": "Enable LLM-powered AI reasoning capabilities"
            },
            {
                "name": "llmApiKey",
                "type": "password",
    ...
    static const std::string manifest = R"json(
{
    ...
    "deviceAgentSettingsModel": {
        "settings": [
            ...
            {
                "name": "enableAIReasoning",
                "type": "boolean",
                "defaultValue": true,
                "description": "Enable AI reasoning for advanced analysis"
            },
            {
                "name": "reasoningConfidenceThreshold",
                "type": "float",
                "defaultValue": 0.65,
                "description": "Confidence threshold for AI reasoning (0.0-1.0)"
            },
            {
                "name": "reasoningInterval",
                "type": "int",
                "defaultValue": 60,
                "description": "Interval between reasoning cycles (seconds)"
            },
            {
                "name": "enableCrossCameraAnalysis",
                "type": "boolean",
                "defaultValue": true,
                "description": "Enable cross-camera correlation and analysis"
            }
        ]
    }
}
